...
from geodf import GeoSeries
from geodf.plotting import plot_dataframe
import geodf.io
...
class GeoDataFrame(geodf.base.GeoDfBase, DataFrame):
    """
    ...
    def from_shapefile(cls, filename, **kwargs):
        ...
        """
        return geodf.io.file.read_shapefile(filename, **kwargs)
    ...
    def to_file(self, filename, driver="ESRI Shapefile", schema=None,
        ...
        """
        from geodf.io.file import to_file
